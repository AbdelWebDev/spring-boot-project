	...
	<div class="container">
		...
		<form:form method="POST" modelAttribute="userForm" class="form-signin">
			...
			<spring:bind path="poid">
				<div class="form-group ${status.error ? 'has-error' : ''}">
					<label> Poid </label>
					<form:input type="number" path="poid" class="form-control"
						placeholder="poid" autofocus="true"></form:input>
					<form:errors path="poid"></form:errors>
				</div>
			</spring:bind>

			<spring:bind path="taille">
				<div class="form-group ${status.error ? 'has-error' : ''}">
					<label> taille </label>
					<form:input type="number" path="taille" class="form-control"
						placeholder="taille" autofocus="true"></form:input>
					<form:errors path="taille"></form:errors>
				</div>
			</spring:bind>
